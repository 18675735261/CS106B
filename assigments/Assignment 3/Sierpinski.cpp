...
void drawSierpinskiTriangle(GWindow& window,
    ...
    if(order <0){
        error("order is less then than 0");
    }
    if(order==0){
        ...
        // double x5=2*x2-x0;
        // double y5=2*y2-y0;
        // drawTriangle(window,x1,y1,x3,y3,x4,y4);
        // drawTriangle(window,x2,y2,x5,y5,x4,y4);
        // drawTriangle(window,x0,y0,x1,y1,x2,y2);
        // //drawSierpinskiTriangle(window,x0,y0,x3,y3,x5,y5,order-1);
        // drawSierpinskiTriangle(window,x1,y1,x3,y3,x4,y4,order-1);
        // drawSierpinskiTriangle(window,x2,y2,x5,y5,x4,y4,order-1);
        // drawSierpinskiTriangle(window,x0,y0,x1,y1,x2,y2,order-1);
