...
//                 c.add(temp1);
//                 v.remove(0);
//                 allEmphasesOfHepler(v,s,c);
//                 v.insert(0,temp1);
//                 c.remove(c.size()-1);
//             }else{
//                 string temp=v[0];
//                 c.add(toUpperCase(temp));
//                 v.remove(0);
//                 allEmphasesOfHepler(v,s,c);
//                 v.insert(0,temp);
//                 c.remove(c.size()-1);
